      ...
      <div className="mx-auto flex min-h-[85vh] w-full max-w-5xl items-center justify-center">
        <div className="w-full max-w-md rounded-2xl border border-[white]/40 bg-zinc-900/70 p-8 shadow-2xl shadow-black/50 backdrop-blur">
          ...
          <form onSubmit={""} className="mt-8 space-y-5">
            ...
            <button
              type="submit"
              className="w-full rounded-lg bg-[white] px-4 py-3 font-semibold text-zinc-950 transition hover:bg-[#ffcece] focus:outline-none focus:shadow-[0_0_0_3px_rgba(49,184,198,0.35)]"
            >
              Login
            </button>
          </form>
          ...
          <p className="mt-6 text-center text-sm text-zinc-300">
            ...
            <Link
              to="/register"
              className="font-semibold text-[#ff3318] transition hover:text-[#ff2617]"
            >
              Register
            </Link>
          </p>
